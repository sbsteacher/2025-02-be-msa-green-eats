...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleExceptionInternal(ErrorCode errorCode, BindException bindException) {
    ...
    private List<MyErrorResponse.FieldError> getValidationError(BindException e) {
